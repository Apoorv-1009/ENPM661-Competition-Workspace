...
class AStarController(Node):
    ...
    def astar(self):
        ...
        x_start, y_start, theta_start = 0, 1000, 0
        ...
        distance_threshold = 80 #mm
        angular_threshold = 60  #deg  
        rpm1, rpm2 = 60, 120 #rpm
    ...
    def controller(self):
        ...
        if self.i < self.path_length:
            ...
            velocity_message.linear.x = 0.9 * distance_error
