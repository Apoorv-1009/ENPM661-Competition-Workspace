...
class AStarController(Node):
    ...
    def robot_params(self):
        ...
        self.clearance = 40 + self.ROBOT_RADIUS #mm   
    ...
    def astar(self):
        ...
        rpm1, rpm2, rpm3 = 40, 50, 80 #rpm # RELIABLE: 36s
    ...
    def controller(self):
        ...
        if self.i < self.path_length:
            ...
            distance_error = min(0.2, distance_error)

            # Get a twist message
            velocity_message = Twist()

            # Apply the proportional controller
            velocity_message.linear.x =  distance_error
            ...
            if dist((self.x, self.y), (x_, y_)) < 0.25:
                self.i += 1
